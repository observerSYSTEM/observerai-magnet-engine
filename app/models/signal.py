...
class Signal(Base):
    ...
    atr_m1: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    liquidity_target: Mapped[float | None] = mapped_column(Float, nullable=True)
    dashboard_target: Mapped[float | None] = mapped_column(Float, nullable=True)
    telegram_target: Mapped[float | None] = mapped_column(Float, nullable=True)
    ea_tp: Mapped[float | None] = mapped_column(Float, nullable=True)
    ea_sl: Mapped[float | None] = mapped_column(Float, nullable=True)
